...
// The base64 data-URI (font.ts) caused delayRender timeouts on long renders —
// load the same woff2 from public/ instead.
loadFont({ family: 'Jakarta', url: staticFile('jakarta.woff2'), format: 'woff2' });
...
// TTS dropped (see git history) and the .wav files were never committed —
// keep the export so BoxDemoIG's import compiles, but render nothing.
export const Voiceover: React.FC = () => null;
