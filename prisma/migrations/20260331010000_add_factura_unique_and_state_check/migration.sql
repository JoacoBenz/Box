...
CHECK ("estado" IN ('borrador', 'enviada', 'devuelta_resp', 'validada', 'devuelta_dir', 'aprobada', 'rechazada', 'en_compras', 'pago_programado', 'comprada', 'recibida', 'recibida_con_obs', 'cerrada'));
