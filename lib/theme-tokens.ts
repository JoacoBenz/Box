...
export const lightTokens: ThemeTokens = {
  ...
  authGradient: 'linear-gradient(135deg, #f0fdff 0%, #e0f7fa 100%)',
  authCircle1: 'rgba(0, 194, 203, 0.08)',
  authCircle2: 'rgba(0, 194, 203, 0.06)',
  authCircle3: 'rgba(0, 194, 203, 0.05)',
  sidebarBg: 'linear-gradient(180deg, #fafeff 0%, #ecfbfc 100%)',
  sidebarBorder: '#f1f5f9',
  logoGradient: 'linear-gradient(135deg, #00C2CB, #0891b2)',
  headerBg: '#ffffff',
  headerBorder: '#e2e8f0',
  headerShadow: '0 1px 3px rgb(0 0 0 / 0.04)',
  searchBgActive: '#ffffff',
  searchBgInactive: '#fafafa',
  searchShadow: '0 0 0 3px rgba(8, 145, 178, 0.1)',
  avatarGradient: 'linear-gradient(135deg, #00C2CB, #0891b2)',
  notifBg: '#ffffff',
  ...
  forgotPasswordColor: '#0891b2',
  loginBtnTextColor: '#ffffff',

  tenantSelectorBg: 'linear-gradient(135deg, #f0fdff, #e0f7fa)',
  tenantSelectorBorder: '#a5e8ed',
};
