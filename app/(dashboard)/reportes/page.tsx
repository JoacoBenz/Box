...
export default function ReportesPage() {
  ...
  const totalGasto =
    data?.gastosPorArea?.reduce((sum, r) => sum + Number(r.gasto_total || 0), 0) ?? 0;
  const totalCompras =
    data?.topProveedores?.reduce((sum, r) => sum + Number(r.num_compras || 0), 0) ?? 0;
    ...
    >
      ...
      {loading ? (
        ...
        <>
          ...
          <Card
            title={
              <span style={{ fontWeight: 700, color: tokens.textPrimary }}>Gasto por Producto</span>
            }
