...
export default function ConfiguracionSSOPage() {
  ...
  return (
    <div className="page-content">
      <Title
        level={3}
        style={{ margin: 0, marginBottom: 24, fontWeight: 700, color: 'var(--text-primary)' }}
      >
        Configuración SSO
      </Title>
      ...
      <Spin spinning={loading}>
        <Card style={{ maxWidth: 600 }}>
          <Form form={form} layout="vertical" {...formProps}>
              ...
              rules={[
                {
                  ...
                  message: 'Ingresá un dominio válido (ej: escuela.edu.ar)',
                },
              ]}
            ...
            <Text
              type="secondary"
              style={{ display: 'block', marginTop: -16, marginBottom: 24, fontSize: 13 }}
            >
              Permite a los usuarios iniciar sesión con su cuenta de Microsoft (Entra ID) del
              dominio configurado.
            </Text>
