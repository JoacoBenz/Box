...
const CRITICAL_ACTIONS = [
  'login_fallido', 'cuenta_bloqueada', 'rate_limited',
  'editar_usuario', 'desactivar_usuario',
  'crear_delegacion', 'desactivar_delegacion',
  'aprobar_solicitud', 'aprobar_masivo',
  'anular_solicitud', 'registrar_compra', 'rechazar_solicitud',
  'configuracion_sso', 'configuracion_tenant',
];

export const GET = withAuth({ roles: ['super_admin', 'admin'] }, async (request, { session, db }) => {
